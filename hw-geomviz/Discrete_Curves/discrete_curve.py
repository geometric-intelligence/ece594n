...
class DiscreteCurveViz:
    ...
    def resample(self, adjusted_sampling_points):
        ...
        self.n = len(adjusted_sampling_points[0])
    ...
    def plot_geodesic(self, n_times, inital_index, end_index, linestyles, labels, title):
        ...
        Parameters
            ...
            """
        geod_fun = self.dim.square_root_velocity_metric.geodesic(
            initial_curve=self.curve_points[inital_index], end_curve=self.curve_points[end_index]
            )

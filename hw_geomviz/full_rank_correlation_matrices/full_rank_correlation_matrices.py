...
#added on
from geomstats.geometry.spd_matrices import SPDMetricAffine, SPDMatrices

import sys
sys.path.insert(1,'/Users/jakebentley/Desktop/geomstats/geomstats/geometry/')
import lower_triangular_matrices
from lower_triangular_matrices import StrictlyLowerTriangularMatrices
sys.path.insert(1,'/Users/jakebentley/Desktop/geomstats/geomstats/geometry/')
import pullback_metric
from pullback_metric import PullbackDiffeoMetric

#sys.path.insert(1,'/Users/jakebentley/Desktop/geomstats/geomstats/geometry/')
#import spd_matrices
#from spd_matrices import SPDMatrices

#the same
from geomstats.geometry.matrices import Matrices
from geomstats.geometry.quotient_metric import QuotientMetric
#from geomstats.geometry.spd_matrices import SPDMetricAffine, SPDMatrices, SPDBuresWassersteinMetric, SPDEuclideanMetric, SPDLogEuclideanMetric
...
class FullRankCorrelationEuclideanCholeskyMetric(PullbackDiffeoMetric):
    ...
    def __init__(self, n):
        self.n = n
        super().__init__(dim=int(n * (n - 1) / 2))
        #self._embedding_metric = StrictlyLowerTriangularMatrices(n).metric
        

    #Professors error help
    def define_embedding_metric(self):
        return StrictlyLowerTriangularMatrices(self.n).metric
